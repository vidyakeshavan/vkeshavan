<template>
 <div class="mincontain">
  ...
  <div class="container">
        ...
        <div class="row p4one">
          <div class="twelve columns subhead"> Product Design </div>
        </div>
        ...
        <div class="row p10 mb2 mr2">
          <div class="four columns mb2 role">
           ...
           <b> Status: </b> Completed, Solo Student Project Spring '18
          </div>

          <div class="eight columns mb2 role">
            ...
            phone-related time management issues through a customized
            reminder system. 
          </div>
       </div>
    ...
    <div class="row p10">
        ...
        <div class="four columns role mb2 ">
         ...
         the media-fueled concern that our society is tech addicted. 
      ...
      <div class="row p10">
         ...
         <div class="row p10 imgpadtop">
          ...
          <div class="row p10 imgpadtop imgpadbot">
            ...
            <div class="row p10 imgpadtop imgpadbot">
                <div class="twelve columns role mr2">
                It's impossible to track time spent on each app 
                because there are no public APIs for tracking app use 
                on an iOS device. <a href="https://i.kinja-img.com/gawker-media/image/upload/s--3MRoVHwV--/c_scale,f_auto,fl_progressive,q_80,w_800/bscnob1vjft6h1chb7e8.jpg"> Moment iOS</a> 
                app aims to circumvent this, 
                but it requires users to take a screenshot of their device
        ...
        <div class="row p10 imgpadtop imgpadbot">
          ...
          <div class="row p10 imgpadtop imgpadbot">
              <div class="twelve columns role mb2">
                  <img src="../assets/img/medfibreak.png" align="top">
                </div>
              </div>
